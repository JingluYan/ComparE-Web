...
$.fn.KinSlideshow = function(settings){
	  ...
	  settings = jQuery.extend({
		   ...
		   isHasTitleBar:true,
		   titleBar:{titleBar_height:30,titleBar_bgColor:"#CCCCCC",titleBar_alpha:0.5},
		   isHasTitleFont:true,
		   titleFont:{TitleFont_size:16,TitleFont_color:"#0000CC",TitleFont_family:"Arial, Helvetica, sans-serif",TitleFont_weight:"bold"},
		   isHasBtn:true,
		   btn:{btn_bgColor:"#666666",btn_bgHoverColor:"#CC0000",btn_fontColor:"#CCCCCC",btn_fontHoverColor:"#000000",btn_fontFamily:"Verdana",btn_borderColor:"#999999",btn_borderHoverColor:"#FF0000",btn_borderWidth:0,btn_bgAlpha:0.7}
	  },settings);
	  var titleBar_Bak = {titleBar_height:30,titleBar_bgColor:"#000000",titleBar_alpha:0.5}
	  var titleFont_Bak = {TitleFont_size:16,TitleFont_color:"#FFFFFF",TitleFont_family:"Arial, Helvetica, sans-serif",TitleFont_weight:"bold"}
	  var btn_Bak = {btn_bgColor:"#666666",btn_bgHoverColor:"#CC0000",btn_fontColor:"#CCCCCC",btn_fontHoverColor:"#000000",btn_fontFamily:"Verdana",btn_borderColor:"#999999",btn_borderHoverColor:"#FF0000",btn_borderWidth:0,btn_bgAlpha:0.7} 
	 ...
	 function KSS_setTitleBar(){
		...
		$(ksbs+" .KSS_titleBar").css({height:getTitleBar_Height,width:950,position:"absolute",bottom:5,left:0})
	 ...
	 function KSS_setTitleFont(){
		 if(settings.isHasTitleFont){
			$(ksthis).append("<div class='KSS_titleBox'><h2 class='title' style='margin:5px 5px 5px 0px;padding:0;'></h2></div>");
			$(ksbs+" .KSS_titleBox").css({height:getTitleBar_Height,width:"100%",position:"absolute",bottom:7,left:0})
	 ...
	 function KSS_setBtn(){
		 ...
		 if(settings.isHasBtn && KSS_imgaeLength >= 2){
			 $(ksthis).append("<div class='KSS_btnBox' style='position:absolute;right:25px;bottom:8px; z-index:100'></div>");
			 var KSS_btnList = "";
